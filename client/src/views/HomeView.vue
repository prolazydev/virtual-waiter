...
<div id="homePage">
    ...
    <section id="statistics" class="home-container bg-rose-950 text-white">
        <!-- <div class="w-3 h-3 mx-auto bg-rose-200 origin-center rounded-full"></div> -->
        <h2 class="mx-auto relative w-fit text-3xl font-semibold uppercase">We&#x2019;re Good with Numbers</h2>
        <!-- <h2 class="mx-auto relative w-fit text-3xl font-semibold ">We&#x2019;re Good with Numbers</h2> -->
        <!-- <h2 class="text-3xl font-semibold text-center">We&#x2019;re Good with Numbers</h2> -->
            ...
            <div class="w-full flex gap-20">
                ...
                <div class="w-full flex justify-start gap-20 overflow-visible">
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <!-- <h3 class="text-7xl font-bold text-center">{{ virtualWaiterData.reviews }}</h3> -->
