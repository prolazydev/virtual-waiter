	...
	<section class="w-full flex flex-col h-full">
		<div class="flex flex-col mx-auto">
			<h1 class="w-fit text-3xl font-bold text-[#1b1b1b] uppercase tracking-widest">
                General Settings for {{ businessDisplayName }}
            </h1>
            ...
            <div class="hidden gap-5">
                ...
                <!-- <div class="w-60 flex flex-col gap-3"> -->
                    ...
                    <!-- <div class="w-full flex flex-col gap-2">
                        ...
                        <MyDialog _class="profile-image-dialog">
                            <template #head>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <MyDialog _class="cover-image-dialog">
                            <template #head>
        ...
        <!-- <div class="setting">
            <div class="form-part flex-col">
                <MyDialog _class="restaurant-info-dialog p-7" :title="`${business.displayName} Information Settings`" size="full">
                    <div @click="toggleDialog('.restaurant-info-dialog')" class="form-button-2" role="button" >
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <div class="hours-table">
                                                ...
                                                <div v-for="(key) in Object.keys(business!.hours!)" :key="key" class="flex">
                                                    ...
                                                    <p v-if="business!.is24">Open 24h</p>
                                                    <p v-else>
                                                        {{ business!.hours![key as Days] ? business!.hours![key as Days] : '00:00-00:00' }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
